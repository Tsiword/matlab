...
close all;
figure(1),plot(s_c,v_chargen,'--',s_c,sv(t_c,s_c),'LineWidth',1),hold on;
plot(s_d,v_dischargen,'--',s_d,sv(t_d,s_d),'LineWidth',1);
legend('Measured charge curve','Modelled charge curve','Measured discharge curve','Modelled discharge curve','Location','SouthEast');
xlabel('SOC'),ylabel('Voc(V)'),title('Constant current charge/discharge curve of baterry');